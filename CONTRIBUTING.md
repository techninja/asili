...
See the [README](README.md#local-development) for full setup including data sync options.
...
and hosted on [data.asili.dev](https://data.asili.dev). This repo is the
browser app only. To add or modify traits, work in asili-lab and redeploy
data via `pnpm run deploy-data`.
